...
const LINUX_FILES = [
  `MyCrypto-${VERSION}-i386.AppImage`,
  `MyCrypto-${VERSION}-x86_64.AppImage`,    
]
const WINDOWS_FILES = [
  `MyCrypto Setup ${VERSION}.exe`,
  `MyCrypto Setup ${VERSION}.exe.blockmap`
]
const OSX_FILES = []
const FLAVOR = (() => {
...
const S3_BUCKET = 'electron-builds-test'
